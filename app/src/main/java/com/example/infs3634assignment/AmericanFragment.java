...
public class AmericanFragment extends Fragment {
    ...
    public static AmericanFragment newInstance(String param1, String param2) {
        AmericanFragment fragment = new AmericanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_american, container, false);

        String url = "https://api.spoonacular.com/recipes/complexSearch?cuisine=american&diet=ketogenic&maxCarbs=5&minFat=0&minProtein=0&minCalories=0&addRecipeInformation=true&number=10&apiKey=729163f9193a406bad906488d2b607f9";
